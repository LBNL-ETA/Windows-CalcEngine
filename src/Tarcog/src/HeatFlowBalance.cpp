...
namespace Tarcog
{
                                     ...
                                     int const t_Index)
    {
        ...
        {
            const double environmentRadiosity = std::dynamic_pointer_cast<CEnvironment>(t_Previous)->getEnvironmentIR();
            const double airTemperature = std::dynamic_pointer_cast<CEnvironment>(t_Previous)->getGasTemperature();
        ...
        {
            const double environmentRadiosity = std::dynamic_pointer_cast<CEnvironment>(t_Next)->getEnvironmentIR();
            const double airTemperature = std::dynamic_pointer_cast<CEnvironment>(t_Next)->getGasTemperature();
