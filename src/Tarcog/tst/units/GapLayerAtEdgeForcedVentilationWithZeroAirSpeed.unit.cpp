...
{
    SCOPED_TRACE("Begin Test: Test Forced Ventilated Gap Layer With Zero Air Speed - Airflow Reference Point");
    ...
    EXPECT_NEAR(0.67938685984566982, airflowReferencePoint, 1e-4);
}
