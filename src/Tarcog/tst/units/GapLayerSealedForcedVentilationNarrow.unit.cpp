...
{
    SCOPED_TRACE("Begin Test: Test Sealed Forced Ventilated Narrow Gap Layer - Solid 1 Temperatures");
...
{
    SCOPED_TRACE("Begin Test: Test Sealed Forced Ventilated Narrow Gap Layer - Solid 2 Temperatures");
