...
TEST_F(NFRC102_NFRC102_VacuumHexagonPillar, Test1)
{
    ...
    std::vector correctTemperature = {258.099309, 258.361978, 282.019959, 282.282629};
    ...
    std::vector correctRadiosity = {249.789437, 267.249197, 344.031854, 370.309355};
    ...
    EXPECT_NEAR(2.209686, uValue, tolerance);
}
