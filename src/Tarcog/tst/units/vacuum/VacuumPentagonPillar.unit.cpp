...
TEST_F(NFRC102_NFRC102_VacuumPentagonPillar, Test1)
{
    ...
    std::vector correctTemperature = {258.090745, 258.352651, 282.053426, 282.315332};
    ...
    std::vector correctRadiosity = {249.761390, 267.241236, 344.173614, 370.449514};
    ...
    EXPECT_NEAR(2.203258, uValue, tolerance);
}
