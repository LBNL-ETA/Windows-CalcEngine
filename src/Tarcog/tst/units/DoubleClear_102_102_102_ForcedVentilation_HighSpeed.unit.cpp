...
class TestDoubleClear102_102_102_ForcedVentilation_HighSpeed : public testing::Test
{
protected:
    [[nodiscard]] static std::shared_ptr<Tarcog::ISO15099::COutdoorEnvironment>
    ...
    [[nodiscard]] static std::shared_ptr<Tarcog::ISO15099::CIndoorEnvironment>
      nfrcWinterRoomConditions()
    {
    ...
    [[nodiscard]] static std::shared_ptr<Tarcog::ISO15099::CIGUSolidLayer> createSolidLayer102()
    {
    ...
    [[nodiscard]] static std::shared_ptr<Tarcog::ISO15099::CIGUGapLayer> createGap()
    {
        constexpr auto gapThickness = 0.0127;   // [m]
        return Tarcog::ISO15099::Layers::gap(gapThickness);
    }

    [[nodiscard]] static std::shared_ptr<Tarcog::ISO15099::CIGUGapLayer>
      createForcedVentilationGap()
    {
        constexpr auto gapThickness = 0.0127;   // [m]
...
TEST_F(TestDoubleClear102_102_102_ForcedVentilation_HighSpeed, WinterSystem)
{
    ...
    auto aSolidLayer3{createSolidLayer102()};
    auto gap{createGap()};
    ...
    aIGU.addLayers({aSolidLayer1, gap, aSolidLayer2, forcedGapLayer, aSolidLayer3});
    ...
    std::vector correctSolidConductivities{1.0, 1.0, 1.0};
    ...
    std::vector correctGapConductivities{0.095385, 1.0};
...
TEST_F(TestDoubleClear102_102_102_ForcedVentilation_HighSpeed, SummerSystem)
{
    constexpr auto Tolerance = 1e-6;
