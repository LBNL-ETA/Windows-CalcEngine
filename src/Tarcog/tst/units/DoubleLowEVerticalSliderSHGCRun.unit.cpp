...
class TestDoubleLowEVerticalSliderSHGCRun : public testing::Test
{
private:
...
protected:
    void SetUp() override
    {
        ...
        m_Window.setFrameData({{DualVerticalFramePosition::Top, frameData},
...
TEST_F(TestDoubleLowEVerticalSliderSHGCRun, Test1)
{
    ...
    EXPECT_NEAR(UValue, 1.833626, Tolerance);

    const auto SHGC{window.shgc()};
    EXPECT_NEAR(SHGC, 0.359156, Tolerance);
