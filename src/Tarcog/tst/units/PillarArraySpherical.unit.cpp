...
{
protected:
    static std::shared_ptr<Tarcog::ISO15099::CIGUGapLayer> createModel(double contactRadius)
    {   /////////////////////////////////////////////////////////
        /// IGU
        /////////////////////////////////////////////////////////
        ...
        auto gap = Tarcog::ISO15099::Layers::sphericalPillar(
          contactRadius, pillarHeight, pillarConductivity, pillarArea, gapPressure);
