...
TEST(TestErrorHandlingSolidLayer, SolidLayerThickness)
{
    ...
    EXPECT_THROW(Tarcog::ISO15099::CIGUSolidLayer(-1.0, 1.0, nullptr, nullptr), std::runtime_error);
}
...
TEST(TestErrorHandlingSolidLayer, SolidLayerFrontEmissivity)
{
    ...
    EXPECT_THROW(Tarcog::ISO15099::CIGUSolidLayer(1.0, 1.0, -1.0, 0.0, 0.0, 0.0),
                 std::runtime_error);
}
...
TEST(TestErrorHandlingSolidLayer, SolidLayerFrontIRTransmittance)
{
    ...
    EXPECT_THROW(Tarcog::ISO15099::CIGUSolidLayer(1.0, 1.0, 1.0, -1.0, 0.0, 0.0),
                 std::runtime_error);
}