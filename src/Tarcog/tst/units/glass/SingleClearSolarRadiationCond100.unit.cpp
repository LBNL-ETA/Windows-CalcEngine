...
TEST_F(TestSingleClearSolarCond001, TestTempAndRad)
{
    ...
    const std::vector correctTemperature{299.627742, 299.627975};
    ...
    const std::vector correctRadiosity{444.699763, 451.769813};
...
TEST_F(TestSingleClearSolarCond001, TestIndoor)
{
    ...
    EXPECT_NEAR(-12.135453, convectiveHF, Tolerance);
    EXPECT_NEAR(-27.311063, radiativeHF, Tolerance);
    EXPECT_NEAR(-39.446516, totalHF, Tolerance);
}
