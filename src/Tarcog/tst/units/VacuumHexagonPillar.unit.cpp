...
TEST_F(NFRC102_NFRC102_VacuumHexagonPillar, Test1)
{
    ...
    std::vector correctTemperature = {258.056300, 258.315132, 282.188077, 282.446909};
    ...
    std::vector correctRadiosity = {249.648603, 267.209355, 344.744502, 371.013915};
    ...
    EXPECT_NEAR(2.177403, uValue, tolerance);
}
