...
protected:
    ...
    std::shared_ptr<Tarcog::ISO15099::CIGUGapLayer> createModel(double length, double width)
    {
        ...
        // Create the rectangular pillar gap
        ...
        // Minimal artificial temperature gradient for calculation
