...
class DoubleLowEVacuumLinearBearingPillar : public testing::Test
{
private:
...
protected:
    void SetUp() override
    {
        ...
        auto pillarGap = Tarcog::ISO15099::Layers::linearBearingPillar(
          pillarLength, pillarWidth, pillarHeight, pillarConductivity, pillarArea, gapPressure);
...
TEST_F(DoubleLowEVacuumLinearBearingPillar, Test1)
{
