...
protected:
    void SetUp() override
    {
        ...
        // transmittance
        std::shared_ptr<ISurface> frontSurface =
          std::make_shared<CSurface>(emissivity, transmittance);
        std::shared_ptr<ISurface> backSurface =
        ...
        auto aSolidLayer = std::make_shared<CIGUSolidLayer>(
