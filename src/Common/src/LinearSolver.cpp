...
namespace FenestrationCommon {
  ...
  vector< double > CLinearSolver::checkSingularity( CSquareMatrix& t_MatrixA ) {
  ...
  vector< size_t > CLinearSolver::makeUpperTriangular( CSquareMatrix& t_MatrixA ) {
    auto TINY = 1e-20;
