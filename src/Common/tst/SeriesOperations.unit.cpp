...
protected:
    void SetUp() override
    {
        m_Series1 = wce::make_unique<CSeries>(std::initializer_list<std::pair<double, double>>({

          {0.50, 3.3}, {0.51, 5.2}, {0.52, 8.9}, {0.53, 10.1}, {0.54, 11.4}

        }));

        m_Series2 = wce::make_unique<CSeries>(std::initializer_list<std::pair<double, double>>({

          {0.50, 1.2}, {0.51, 6.1}, {0.52, 7.3}, {0.53, 9.5}, {0.54, 10.4}}));
    }
