...
TEST(TestSimpleTrapezoidalIntegration, TestTrapezoidal)
{
    ...
    const auto series = integrate(IntegrationType::Trapezoidal, input);

    const CSeries correctValues{{10, 125}, {15, 175}};
