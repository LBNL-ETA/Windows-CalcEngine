...
namespace SpectralAveraging
{
    ...
    // classes and tha will depend on type of the sample data First class for single measurement at
    // certain angle
    class CSingleAngularMeasurement
    {
    public:
        CSingleAngularMeasurement(std::shared_ptr<CSpectralSample> const & t_Data,
    ...
    public:
        ...
        // You want to provide different measurement and also you want to provide common wavelengths
        // (set of points for interpolation)
