...
namespace Gases
{
    ...
    ZeroMolecularWeightError::ZeroMolecularWeightError(const std::string & message) :
    ...
    ZeroDynamicalViscosityError::ZeroDynamicalViscosityError(const std::string & message) :
        runtime_error(message)
    {}
    ...
    ZeroThermalConductivityCoefficientError::ZeroThermalConductivityCoefficientError(
      const std::string & message) :
        runtime_error(message)
    {}
}   // namespace Gases