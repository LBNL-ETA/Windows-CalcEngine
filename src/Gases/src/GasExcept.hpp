...
namespace Gases
{
    ...
    public:
        explicit ZeroMolecularWeightError(
          const std::string & message =
            "Molecular weight of gas component in gas mixture is set to be equal to zero.");
    };
    ...
    public:
        explicit ZeroViscosityError(
          const std::string & message =
            "Viscosity of gas component in gas mixture is set to be equal to zero.");
    };
    ...
    public:
        explicit ZeroDynamicalViscosityError(
          const std::string & message =
            "Dynamical viscosity of gas component in gas mixture is set to be equal to zero.");
    };
    ...
    public:
        explicit ZeroPrimaryThermalConductivityCoefficientError(
          const std::string & message = "Primary thermal conductivity (lambda prim) of the gas "
