...
protected:
	virtual void SetUp() {
		...
		// Segment 2
		shared_ptr< CPoint2D > aStartPoint2 = make_shared< CPoint2D >( 0, 5 );
		shared_ptr< CPoint2D > aEndPoint2 = make_shared< CPoint2D >( 10, 5 );
		...
		// Segment 3
		shared_ptr< CPoint2D > aStartPoint3 = make_shared< CPoint2D >( 5, 2 );
		shared_ptr< CPoint2D > aEndPoint3 = make_shared< CPoint2D >( 0, 2 );
...
public:
	shared_ptr< CGeometry2D > getEnclosure() {
