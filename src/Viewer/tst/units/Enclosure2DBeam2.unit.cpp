...
protected:
    void SetUp() override
    {
        ...
        std::shared_ptr<CViewSegment2D> aSegment1_1 =
          std::make_shared<CViewSegment2D>(aStartPoint1_1, aEndPoint1_1);
        ...
        std::shared_ptr<CViewSegment2D> aSegment1_2 =
          std::make_shared<CViewSegment2D>(aStartPoint1_2, aEndPoint1_2);
        ...
        std::shared_ptr<CViewSegment2D> aSegment1_3 =
          std::make_shared<CViewSegment2D>(aStartPoint1_3, aEndPoint1_3);
        ...
        std::shared_ptr<CViewSegment2D> aSegment1_4 =
          std::make_shared<CViewSegment2D>(aStartPoint1_4, aEndPoint1_4);
        ...
        std::shared_ptr<CViewSegment2D> aSegment2_1 =
          std::make_shared<CViewSegment2D>(aStartPoint2_1, aEndPoint2_1);
        ...
        std::shared_ptr<CViewSegment2D> aSegment2_2 =
          std::make_shared<CViewSegment2D>(aStartPoint2_2, aEndPoint2_2);
        ...
        std::shared_ptr<CViewSegment2D> aSegment2_3 =
          std::make_shared<CViewSegment2D>(aStartPoint2_3, aEndPoint2_3);
