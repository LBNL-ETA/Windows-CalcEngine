...
protected:
	void SetUp() override {
		...
		// Segment 3
		shared_ptr< CPoint2D > aStartPoint3 = make_shared< CPoint2D >( 1, 1 );
		shared_ptr< CPoint2D > aEndPoint3 = make_shared< CPoint2D >( 1, 0 );
		...
		// Segment 4
		shared_ptr< CPoint2D > aStartPoint4 = make_shared< CPoint2D >( 1, 0 );
...
public:
	shared_ptr< CGeometry2D > getEnclosure() const {
