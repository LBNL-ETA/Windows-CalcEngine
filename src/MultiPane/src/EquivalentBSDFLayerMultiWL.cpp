...
namespace MultiPane {
  ...
  CEquivalentBSDFLayerMultiWL::CEquivalentBSDFLayerMultiWL( shared_ptr< vector< double > > t_CommonWavelengths,
    ...
    m_LayersWL = make_shared< vector< shared_ptr< CEquivalentBSDFLayer > > >();
    ...
    for( size_t i = 0; i < size; ++i ) {
      ...
      shared_ptr< CEquivalentBSDFLayer > aEquivalentLayer = make_shared< CEquivalentBSDFLayer >( currentLayer );
  ...
  void CEquivalentBSDFLayerMultiWL::addLayer( shared_ptr< CBaseBSDFLayerMultiWL > t_Layer ) {
    ...
    for( size_t i = 0; i < size; ++i ) {
      ...
      assert( index > -1 );
      shared_ptr< CBSDFResults > currentLayer = ( *aResults )[ size_t( index ) ];
      shared_ptr< CEquivalentBSDFLayer > currentEqLayer = ( *m_LayersWL )[ i ];
  ...
  shared_ptr< CSquareMatrix > CEquivalentBSDFLayerMultiWL::Tau( const double minLambda, const double maxLambda, Side t_Side ) {
    if( !m_Calculated ) {
  ...
  shared_ptr< CSquareMatrix > CEquivalentBSDFLayerMultiWL::Rho( const double minLambda, 
  ...
  shared_ptr< vector< double > > CEquivalentBSDFLayerMultiWL::Abs( const double minLambda, const double maxLambda, 
  ...
  void CEquivalentBSDFLayerMultiWL::calculate( const double minLambda, const double maxLambda ) {
    ...
    for( size_t i = 0; i < size; ++i ) {
      ...
      double curWL = ( *m_CombinedLayerWavelengths )[ i ];
      shared_ptr< CEquivalentBSDFLayer > curLayer = ( *m_LayersWL )[ i ];
