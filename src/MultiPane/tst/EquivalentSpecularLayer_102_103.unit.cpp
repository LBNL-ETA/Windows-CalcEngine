...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle0 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 0 deg." );
...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle10 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 10 deg." );
...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle20 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 20 deg." );
...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle30 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 30 deg." );
...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle40 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 40 deg." );
...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle50 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 50 deg." );
...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle60 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 60 deg." );
...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle70 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 70 deg." );
...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle80 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 80 deg." );
...
TEST_F( EquivalentSpecularLayer_102_103, TestAngle90 ) {
  SCOPED_TRACE( "Begin Test: Specular multipane layer - angle = 90 deg." );
