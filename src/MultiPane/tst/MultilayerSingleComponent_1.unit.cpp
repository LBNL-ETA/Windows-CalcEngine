...
protected:
  virtual void SetUp() {
    m_IGU = make_shared< CMultiLayerSingleComponent >( 0.46, 0.52, 0.64, 0.22 );
...
public:
  shared_ptr< CMultiLayerSingleComponent > getIGU() { return m_IGU; };
...
TEST_F( TestMultilayerSingleComponent_1, TestOpticalProperties ) {
  ...
  shared_ptr< CMultiLayerSingleComponent > eqLayer = getIGU();
