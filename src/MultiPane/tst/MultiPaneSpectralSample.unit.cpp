...
class TestMultiPaneSample : public testing::Test
{
...
protected:
  virtual void SetUp() {
    ...
    shared_ptr< CMultiPaneSampleData > multiSample = make_shared< CMultiPaneSampleData >();
...
TEST_F( TestMultiPaneSample, TestDoublePaneProperties ) {
...
TEST_F( TestMultiPaneSample, TestDoublePaneLayerAbsorptances ) {
