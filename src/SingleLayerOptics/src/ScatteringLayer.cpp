...
namespace SingleLayerOptics
{
  ...
  {}
    ...
    double CScatteringLayer::getPropertySimple(
    ...
    CLayerSingleComponent CScatteringLayer::getLayer(const Scattering t_Scattering, const double t_Theta, const double t_Phi)
    {
