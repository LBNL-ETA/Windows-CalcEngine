...
CScatteringSurface::CScatteringSurface(const double T_dir_dir,
                                       const double R_dir_dir, double T_dir_dif,
                                       double R_dir_dif, const double T_dif_dif,
  ...
  if (T_dir_dif != 0 && 1 == T_dir_dir)
    T_dir_dif = 0;
  m_PropertySimple[std::make_pair(PropertySimple::T,
                                  Scattering::DirectDirect)] = T_dir_dir;
  m_PropertySimple[std::make_pair(PropertySimple::R,
                                  Scattering::DirectDirect)] = R_dir_dir;
  m_PropertySimple[std::make_pair(PropertySimple::T,
                                  Scattering::DirectDiffuse)] = T_dir_dif;
  m_PropertySimple[std::make_pair(PropertySimple::R,
                                  Scattering::DirectDiffuse)] = R_dir_dif;
  m_PropertySimple[std::make_pair(PropertySimple::T,
                                  Scattering::DiffuseDiffuse)] = T_dif_dif;
  m_PropertySimple[std::make_pair(PropertySimple::R,
...
double
CScatteringSurface::getPropertySimple(const PropertySimple t_Property,
...
double
CScatteringSurface::getAbsorptance(const ScatteringSimple t_Scattering) const {
