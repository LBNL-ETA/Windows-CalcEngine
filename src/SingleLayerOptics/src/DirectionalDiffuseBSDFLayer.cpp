...
{
    CDirectionalBSDFLayer::CDirectionalBSDFLayer(const std::shared_ptr<CBaseCell> & t_Cell,
    ...
    CMatrixBSDFLayer::CMatrixBSDFLayer(const std::shared_ptr<CBaseCell> & t_Cell,
                                       const BSDFHemisphere & t_Hemisphere) :
