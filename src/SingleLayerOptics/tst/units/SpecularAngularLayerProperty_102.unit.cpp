...
private:
    ...
    std::shared_ptr<CSingleAngularMeasurement> getSample1()
    {
        ...
        const auto aMeasurements0 = CSpectralSampleData::create({
          // incident angle = 0
          {0.290, 0.0, 0.0, 0.0},          {0.295, 0.0, 0.0, 0.0},
          {0.300, 0.0, 0.0, 0.0},          {0.305, 0.0, 0.0, 0.0},
          {0.310, 0.007, 0.007, 0.007},    {0.315, 0.035, 0.035, 0.035},
          {0.320, 0.0975, 0.0975, 0.0975}, {0.325, 0.2099, 0.2099, 0.2099},
          {0.330, 0.3497, 0.3497, 0.3497}, {0.335, 0.4865, 0.4865, 0.4865},
          {0.340, 0.6057, 0.6057, 0.6057}, {0.345, 0.7035, 0.7035, 0.7035},
          {0.350, 0.7687, 0.7687, 0.7687}, {0.355, 0.812, 0.812, 0.812},
          {0.360, 0.8429, 0.8429, 0.8429}, {0.365, 0.862, 0.862, 0.862},
          {0.370, 0.8678, 0.8678, 0.8678}, {0.375, 0.8672, 0.8672, 0.8672},
          {0.380, 0.8554, 0.8554, 0.8554}, {0.385, 0.8696, 0.8696, 0.8696},
          {0.390, 0.8804, 0.8804, 0.8804}, {0.395, 0.8884, 0.8884, 0.8884},
          {0.400, 0.8924, 0.8924, 0.8924}, {0.410, 0.8944, 0.8944, 0.8944},
          {0.420, 0.8921, 0.8921, 0.8921}, {0.430, 0.8914, 0.8914, 0.8914},
          {0.440, 0.8896, 0.8896, 0.8896}, {0.450, 0.8933, 0.8933, 0.8933},
          {0.460, 0.8972, 0.8972, 0.8972}, {0.470, 0.8991, 0.8991, 0.8991},
          {0.480, 0.9013, 0.9013, 0.9013}, {0.490, 0.9026, 0.9026, 0.9026},
          {0.500, 0.9026, 0.9026, 0.9026}, {0.510, 0.9031, 0.9031, 0.9031},
          {0.520, 0.9025, 0.9025, 0.9025}, {0.530, 0.9028, 0.9028, 0.9028},
          {0.540, 0.9033, 0.9033, 0.9033}, {0.550, 0.9013, 0.9013, 0.9013},
          {0.560, 0.8999, 0.8999, 0.8999}, {0.570, 0.8986, 0.8986, 0.8986},
          {0.580, 0.8975, 0.8975, 0.8975}, {0.590, 0.8939, 0.8939, 0.8939},
          {0.600, 0.8919, 0.8919, 0.8919}, {0.610, 0.891, 0.891, 0.891},
          {0.620, 0.8853, 0.8853, 0.8853}, {0.630, 0.8838, 0.8838, 0.8838},
          {0.640, 0.8806, 0.8806, 0.8806}, {0.650, 0.8769, 0.8769, 0.8769},
          {0.660, 0.8735, 0.8735, 0.8735}, {0.670, 0.8731, 0.8731, 0.8731},
          {0.680, 0.8665, 0.8665, 0.8665}, {0.690, 0.8637, 0.8637, 0.8637},
          {0.700, 0.8607, 0.8607, 0.8607}, {0.710, 0.8557, 0.8557, 0.8557},
          {0.720, 0.8531, 0.8531, 0.8531}, {0.730, 0.8487, 0.8487, 0.8487},
          {0.740, 0.8418, 0.8418, 0.8418}, {0.750, 0.8406, 0.8406, 0.8406},
          {0.760, 0.8358, 0.8358, 0.8358}, {0.770, 0.8341, 0.8341, 0.8341},
          {0.780, 0.8324, 0.8324, 0.8324}, {0.790, 0.8232, 0.8232, 0.8232},
          {0.800, 0.8246, 0.8246, 0.8246}, {0.850, 0.8076, 0.8076, 0.8076},
          {0.900, 0.8002, 0.8002, 0.8002}, {0.950, 0.7907, 0.7907, 0.7907},
          {1.000, 0.7862, 0.7862, 0.7862}, {1.050, 0.7849, 0.7849, 0.7849},
          {1.100, 0.7848, 0.7848, 0.7848}, {1.150, 0.7864, 0.7864, 0.7864},
          {1.200, 0.7894, 0.7894, 0.7894}, {1.250, 0.7944, 0.7944, 0.7944},
          {1.300, 0.8014, 0.8014, 0.8014}, {1.350, 0.8088, 0.8088, 0.8088},
          {1.400, 0.8168, 0.8168, 0.8168}, {1.450, 0.8261, 0.8261, 0.8261},
          {1.500, 0.8366, 0.8366, 0.8366}, {1.550, 0.8444, 0.8444, 0.8444},
          {1.600, 0.8506, 0.8506, 0.8506}, {1.650, 0.853, 0.853, 0.853},
          {1.700, 0.8527, 0.8527, 0.8527}, {1.750, 0.8532, 0.8532, 0.8532},
          {1.800, 0.8504, 0.8504, 0.8504}, {1.850, 0.8488, 0.8488, 0.8488},
          {1.900, 0.8523, 0.8523, 0.8523}, {1.950, 0.8497, 0.8497, 0.8497},
          {2.000, 0.848, 0.848, 0.848},    {2.050, 0.8488, 0.8488, 0.8488},
          {2.100, 0.8505, 0.8505, 0.8505}, {2.150, 0.8408, 0.8408, 0.8408},
          {2.200, 0.8304, 0.8304, 0.8304}, {2.250, 0.8277, 0.8277, 0.8277},
          {2.300, 0.8303, 0.8303, 0.8303}, {2.350, 0.834, 0.834, 0.834},
          {2.400, 0.8236, 0.8236, 0.8236}, {2.450, 0.8225, 0.8225, 0.8225},
          {2.500, 0.8184, 0.8184, 0.8184},
        });
