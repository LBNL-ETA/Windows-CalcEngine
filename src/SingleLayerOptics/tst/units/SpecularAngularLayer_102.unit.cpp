...
private:
    ...
    std::shared_ptr<CSingleAngularMeasurement> getSample09()
    {
        ...
        std::shared_ptr<CSpectralSampleData> aMeasurements09 =
          std::make_shared<CSpectralSampleData>();
        // incident angle = 0
        ...
        std::shared_ptr<CSpectralSample> aSample09 =
          std::make_shared<CSpectralSample>(aMeasurements09, aSolarRadiation);
        std::shared_ptr<CSingleAngularMeasurement> aAngular09 =
          std::make_shared<CSingleAngularMeasurement>(aSample09, 90.0);
