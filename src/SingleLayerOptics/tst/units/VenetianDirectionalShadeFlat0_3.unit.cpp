...
TEST_F(TestVenetianDirectionalShadeFlat0_3, TestVenetian1)
{
    ...
    EXPECT_NEAR(0.53829734837924281, tauDiff, 1e-6);

    const double RfDiff = aResults.DiffDiff(Side::Front, PropertySimple::R);
    EXPECT_NEAR(0.19866669600672379, RfDiff, 1e-6);
    ...
    std::vector<double> correctT{
      ...
      12.996986, 5.47603,   0.098802, 0.102213,  0.098802, 5.47603,   12.996986, 5.47603,  0.098804,
      0.103304,  0.098804,  5.47603,  12.996986, 0.100776, 0.097083,  0.093999,  0.097083, 0.100776,
      12.996986, 0.101199,  0.102473, 0.101186,  0.102473, 0.101199,  12.355109, 0.094803, 0.095402,
      0.094803,  12.355109, 0.127734, 0.13675,   0.127734};
    ...
    std::vector<double> correctR{
      ...
      0,        0.033334, 0.098804, 0.103304, 0.098804, 0.033334, 0,        0.033334, 0.098802,
      0.102213, 0.098802, 0.033334, 0,        0.101199, 0.102473, 0.101186, 0.102473, 0.101199,
      0,        0.100776, 0.097083, 0.093999, 0.097083, 0.100776, 0,        0.127734, 0.13675,
      0.127734, 0,        0.094803, 0.095402, 0.094803};
