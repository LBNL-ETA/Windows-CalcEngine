...
protected:
  virtual void SetUp() {
	...
	aAngular0->interpolate( *commonWavelengths );
	aAngular0->getData( );
...
//	m_Measurements->addMeasurement( aAngular09 );
    ...
    shared_ptr< CMaterial > aMaterial = make_shared< CMaterialMeasured >( m_Measurements, thickness, MaterialType::Monolithic, WavelengthRange::Solar );
