...
namespace MultiLayerOptics
{
    ...
    CSurfaceSeries::CSurfaceSeries(const std::shared_ptr<CSeries> & t_T,
                                   const std::shared_ptr<CSeries> & t_R)
    {
    ...
    CLayerSeries::CLayerSeries(const std::shared_ptr<CSeries> & t_Tf,
                               const std::shared_ptr<CSeries> & t_Rf,
                               const std::shared_ptr<CSeries> & t_Tb,
                               const std::shared_ptr<CSeries> & t_Rb)
    {
    ...
    std::shared_ptr<CSeries> CLayerSeries::getProperties(const Side t_Side,
    ...
    CEquivalentLayerSingleComponentMW::CEquivalentLayerSingleComponentMW(
      const std::shared_ptr<CSeries> & t_Tf,
      const std::shared_ptr<CSeries> & t_Tb,
      const std::shared_ptr<CSeries> & t_Rf,
      const std::shared_ptr<CSeries> & t_Rb)
    {
