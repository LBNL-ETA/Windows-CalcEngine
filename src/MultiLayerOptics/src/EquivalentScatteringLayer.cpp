...
namespace MultiLayerOptics
{
    CEquivalentScatteringLayer::CEquivalentScatteringLayer(const double Tf_dir_dir,
        ...
        m_Layer(CScatteringLayer(CScatteringSurface(Tf_dir_dir, Rf_dir_dir, Tf_dir_dif, Rf_dir_dif, Tf_dif_dif, Rf_dif_dif),
    ...
    CEquivalentScatteringLayer::CEquivalentScatteringLayer(CScatteringLayer & t_Layer, const double t_Theta, const double t_Phi) :
    ...
    void CEquivalentScatteringLayer::addLayer(const double Tf_dir_dir,
                                              ...
                                              const Side t_Side)
    {
        CScatteringSurface aFrontSurface(Tf_dir_dir, Rf_dir_dir, Tf_dir_dif, Rf_dir_dif, Tf_dif_dif, Rf_dif_dif);

        CScatteringSurface aBackSurface(Tb_dir_dir, Rb_dir_dir, Tb_dir_dif, Rb_dir_dif, Tb_dif_dif, Rb_dif_dif);

        CScatteringLayer aLayer(aFrontSurface, aBackSurface);
        addLayer(aLayer, t_Side);
    }

    void CEquivalentScatteringLayer::addLayer(CScatteringLayer & t_Layer, const Side t_Side, const double t_Theta, const double t_Phi)
    {
    ...
    double CEquivalentScatteringLayer::getPropertySimple(
    ...
    {
        return 1 - t_First.getPropertySimple(PropertySimple::R, t_Scattering) * t_Second.getPropertySimple(PropertySimple::R, t_Scattering);
    }

    std::shared_ptr<SimpleResults> CEquivalentScatteringLayer::calcDirectDiffuseTransAndRefl(const CScatteringSurface & f1,
                                                                                             ...
                                                                                             const CScatteringSurface & f2) const
    {
        ...
        double I_fwd = (I_b1_dif + I_f2_dif * b1.getPropertySimple(PropertySimple::R, Scattering::DiffuseDiffuse)) / difInterrefl;
        double I_bck = (I_b1_dif * f2.getPropertySimple(PropertySimple::R, Scattering::DiffuseDiffuse) + I_f2_dif) / difInterrefl;
    ...
    void CEquivalentScatteringLayer::addLayerComponents(CScatteringLayer & t_Layer, const Side t_Side, const double t_Theta, const double t_Phi) const
    {
        double Tf = t_Layer.getPropertySimple(PropertySimple::T, Side::Front, Scattering::DirectDirect, t_Theta, t_Phi);
        double Rf = t_Layer.getPropertySimple(PropertySimple::R, Side::Front, Scattering::DirectDirect, t_Theta, t_Phi);
        double Tb = t_Layer.getPropertySimple(PropertySimple::T, Side::Back, Scattering::DirectDirect, t_Theta, t_Phi);
