...
TEST_F( MultiPaneScattered_102_PerfectDiffuse, TestPerfectDiffuseDirectBeam ) {
	SCOPED_TRACE( "Begin Test: Perfectly diffusing layer - Scattering model front side (normal incidence)." );
...
TEST_F( MultiPaneScattered_102_PerfectDiffuse, TestPerfectDiffuseAngledBeam25 ) {
	SCOPED_TRACE( "Begin Test: Perfectly diffusing layer - Scattering model back side (Theta = 25 deg)." );
...
TEST_F( MultiPaneScattered_102_PerfectDiffuse, TestPerfectDiffuseAngleBeam50 ) {
	SCOPED_TRACE( "Begin Test: Perfectly diffusing layer - Scattering model front side (Theta = 50 deg)." );
