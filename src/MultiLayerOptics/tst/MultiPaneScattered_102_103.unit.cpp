...
protected:
  virtual void SetUp() {
    ...
    shared_ptr< CScatteringLayer > Layer_103 = make_shared< CScatteringLayer >( aMaterial_103 );
...
TEST_F( MultiPaneScattered_102_103, TestSpecular1 ) {
  ...
  double A_dif2 = aLayer.getAbsorptanceLayer( 2, aSide, ScatteringSimple::Diffuse, theta, phi );
