...
protected:
    virtual void SetUp()
    {
        ...
        const CalculationProperties input{
          loadSolarRadiationFile(), loadSolarRadiationFile().getXArray(), detector};
