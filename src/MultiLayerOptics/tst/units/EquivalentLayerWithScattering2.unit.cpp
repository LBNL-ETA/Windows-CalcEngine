...
// Test equivalent properties of triple layer with direct-direct, direct-diffuse and diffuse-diffuse
// components Tests include adding layer on back and front sides. EquivalentLayer contains only
...
TEST_F(TestEquivalentLayerWithScattering2, TestTripleLayerBack)
{
    ...
    ///////////////////////////////////////////////
    double Tf =
      doubleLayer.getPropertySimple(PropertySurface::T, Side::Front, Scattering::DirectDirect);
    EXPECT_NEAR(0.000648224, Tf, 1e-6);

    double Rf =
      doubleLayer.getPropertySimple(PropertySurface::R, Side::Front, Scattering::DirectDirect);
    EXPECT_NEAR(0.050534583, Rf, 1e-6);

    double Tb =
      doubleLayer.getPropertySimple(PropertySurface::T, Side::Back, Scattering::DirectDirect);
    EXPECT_NEAR(0.002567576, Tb, 1e-6);

    double Rb =
      doubleLayer.getPropertySimple(PropertySurface::R, Side::Back, Scattering::DirectDirect);
    EXPECT_NEAR(0.250039501, Rb, 1e-6);

    ///////////////////////////////////////////////
    // Diffuse-Diffuse
    ///////////////////////////////////////////////
    Tf = doubleLayer.getPropertySimple(PropertySurface::T, Side::Front, Scattering::DiffuseDiffuse);
    EXPECT_NEAR(0.167799034, Tf, 1e-6);

    Rf = doubleLayer.getPropertySimple(PropertySurface::R, Side::Front, Scattering::DiffuseDiffuse);
    EXPECT_NEAR(0.692483233, Rf, 1e-6);

    Tb = doubleLayer.getPropertySimple(PropertySurface::T, Side::Back, Scattering::DiffuseDiffuse);
    EXPECT_NEAR(0.284211597, Tb, 1e-6);

    Rb = doubleLayer.getPropertySimple(PropertySurface::R, Side::Back, Scattering::DiffuseDiffuse);
    EXPECT_NEAR(0.395593248, Rb, 1e-6);

    ///////////////////////////////////////////////
    // Direct-Diffuse
    ///////////////////////////////////////////////
    Tf = doubleLayer.getPropertySimple(PropertySurface::T, Side::Front, Scattering::DirectDiffuse);
    EXPECT_NEAR(0.197511986, Tf, 1e-6);

    Rf = doubleLayer.getPropertySimple(PropertySurface::R, Side::Front, Scattering::DirectDiffuse);
    EXPECT_NEAR(0.429497739, Rf, 1e-6);

    Tb = doubleLayer.getPropertySimple(PropertySurface::T, Side::Back, Scattering::DirectDiffuse);
    EXPECT_NEAR(0.220590948, Tb, 1e-6);

    Rb = doubleLayer.getPropertySimple(PropertySurface::R, Side::Back, Scattering::DirectDiffuse);
