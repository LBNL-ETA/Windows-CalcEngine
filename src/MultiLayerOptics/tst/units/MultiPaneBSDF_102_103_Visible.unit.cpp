...
class MultiPaneBSDF_102_103_Visible : public testing::Test
{
private:
...
protected:
    virtual void SetUp()
    {
        ...
        m_Layer = CMultiPaneBSDF::create(
          {Layer_102, Layer_103}, loadSolarRadiationFile(), getDetectorData(), commonWavelengths);
    }
...
TEST_F(MultiPaneBSDF_102_103_Visible, TestSpecular1)
{
