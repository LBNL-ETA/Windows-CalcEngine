...
class EquivalentSpecularAngularDualLayer_102_103 : public testing::Test
{
    ...
    static std::shared_ptr<CSingleAngularMeasurement> getSample4()
    {
        ...
        std::shared_ptr<CSpectralSampleData> aMeasurements9 = CSpectralSampleData::create({
          {0.300, 0, 0, 1, 1}, {0.305, 0, 0, 1, 1}, {0.310, 0, 0, 1, 1}, {0.315, 0, 0, 1, 1},
          {0.320, 0, 0, 1, 1}, {0.325, 0, 0, 1, 1}, {0.330, 0, 0, 1, 1}, {0.335, 0, 0, 1, 1},
          {0.340, 0, 0, 1, 1}, {0.345, 0, 0, 1, 1}, {0.350, 0, 0, 1, 1}, {0.355, 0, 0, 1, 1},
          {0.360, 0, 0, 1, 1}, {0.365, 0, 0, 1, 1}, {0.370, 0, 0, 1, 1}, {0.375, 0, 0, 1, 1},
          {0.380, 0, 0, 1, 1}, {0.385, 0, 0, 1, 1}, {0.390, 0, 0, 1, 1}, {0.395, 0, 0, 1, 1},
          {0.400, 0, 0, 1, 1}, {0.410, 0, 0, 1, 1}, {0.420, 0, 0, 1, 1}, {0.430, 0, 0, 1, 1},
          {0.440, 0, 0, 1, 1}, {0.450, 0, 0, 1, 1}, {0.460, 0, 0, 1, 1}, {0.470, 0, 0, 1, 1},
          {0.480, 0, 0, 1, 1}, {0.490, 0, 0, 1, 1}, {0.500, 0, 0, 1, 1}, {0.510, 0, 0, 1, 1},
          {0.520, 0, 0, 1, 1}, {0.530, 0, 0, 1, 1}, {0.540, 0, 0, 1, 1}, {0.550, 0, 0, 1, 1},
          {0.560, 0, 0, 1, 1}, {0.570, 0, 0, 1, 1}, {0.580, 0, 0, 1, 1}, {0.590, 0, 0, 1, 1},
          {0.600, 0, 0, 1, 1}, {0.610, 0, 0, 1, 1}, {0.620, 0, 0, 1, 1}, {0.630, 0, 0, 1, 1},
          {0.640, 0, 0, 1, 1}, {0.650, 0, 0, 1, 1}, {0.660, 0, 0, 1, 1}, {0.670, 0, 0, 1, 1},
          {0.680, 0, 0, 1, 1}, {0.690, 0, 0, 1, 1}, {0.700, 0, 0, 1, 1}, {0.710, 0, 0, 1, 1},
          {0.720, 0, 0, 1, 1}, {0.730, 0, 0, 1, 1}, {0.740, 0, 0, 1, 1}, {0.750, 0, 0, 1, 1},
          {0.760, 0, 0, 1, 1}, {0.770, 0, 0, 1, 1}, {0.780, 0, 0, 1, 1}, {0.790, 0, 0, 1, 1},
          {0.800, 0, 0, 1, 1}, {0.850, 0, 0, 1, 1}, {0.900, 0, 0, 1, 1}, {0.950, 0, 0, 1, 1},
          {1.000, 0, 0, 1, 1}, {1.050, 0, 0, 1, 1}, {1.100, 0, 0, 1, 1}, {1.150, 0, 0, 1, 1},
          {1.200, 0, 0, 1, 1}, {1.250, 0, 0, 1, 1}, {1.300, 0, 0, 1, 1}, {1.350, 0, 0, 1, 1},
          {1.400, 0, 0, 1, 1}, {1.450, 0, 0, 1, 1}, {1.500, 0, 0, 1, 1}, {1.550, 0, 0, 1, 1},
          {1.600, 0, 0, 1, 1}, {1.650, 0, 0, 1, 1}, {1.700, 0, 0, 1, 1}, {1.750, 0, 0, 1, 1},
          {1.800, 0, 0, 1, 1}, {1.850, 0, 0, 1, 1}, {1.900, 0, 0, 1, 1}, {1.950, 0, 0, 1, 1},
          {2.000, 0, 0, 1, 1}, {2.050, 0, 0, 1, 1}, {2.100, 0, 0, 1, 1}, {2.150, 0, 0, 1, 1},
          {2.200, 0, 0, 1, 1}, {2.250, 0, 0, 1, 1}, {2.300, 0, 0, 1, 1}, {2.350, 0, 0, 1, 1},
          {2.400, 0, 0, 1, 1}, {2.450, 0, 0, 1, 1}, {2.500, 0, 0, 1, 1},
        });
