...
class MultiPaneBSDF_Woven_IR : public testing::Test
{
private:
...
TEST_F(MultiPaneBSDF_Woven_IR, TestWovenShade)
{
    SCOPED_TRACE("Begin Test: Woven shade - BSDF IR.");
    ...
    EXPECT_NEAR(0.096296610318422418, rhoDiff, 1e-6);

    double absDiff1 = aLayer.AbsDiff(minLambda, maxLambda, Side::Front, 1);
    EXPECT_NEAR(0.86666949286581452, absDiff1, 1e-6);
}
