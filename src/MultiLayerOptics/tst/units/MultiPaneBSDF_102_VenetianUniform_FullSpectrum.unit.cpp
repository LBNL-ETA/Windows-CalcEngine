...
TEST_F(MultiPaneBSDF_102_VenetianUniform, TestVenetianUniformBSDF)
{
    ...
    EXPECT_NEAR(0.220943415, tauDiff, 1e-6);
    ...
    EXPECT_NEAR(0.135809758, absDiff1, 1e-6);
    ...
    EXPECT_NEAR(0.24526728, tauHem, 1e-6);
    ...
    EXPECT_NEAR(0.366826632, rhoHem, 1e-6);

    double rhoDir =
      aLayer.DirDir(minLambda, maxLambda, Side::Front, PropertySurface::R, theta, phi);
    EXPECT_NEAR(0.0789230127, rhoDir, 1e-6);

    double abs1 = aLayer.Abs(minLambda, maxLambda, Side::Front, 1, theta, phi);
    EXPECT_NEAR(0.129991224, abs1, 1e-6);
