...
TEST_F(MultiPaneBSDF_102_Homogeneous_31100_n_Band_Material, TestBSDF1)
{
    ...
    auto R = aLayer.getMatrix(minLambda, maxLambda, Side::Front, PropertySurface::R);
