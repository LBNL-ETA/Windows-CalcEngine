...
protected:
    virtual void SetUp()
    {
        ...
        m_Interref = std::make_unique<CInterRef>(aLayer1);
...
{
    SCOPED_TRACE(
      "Begin Test: Triple pane equivalent layer properties (Forward flow - Front Side).");
...
{
    SCOPED_TRACE(
      "Begin Test: Triple pane equivalent layer properties (Backward flow - Front Side).");
...
{
    SCOPED_TRACE(
      "Begin Test: Triple pane equivalent layer properties (Backward flow - Back Side).");
