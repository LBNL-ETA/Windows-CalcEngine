...
TEST_F(EquivalentSpecularLayer_21467, TestAngle0)
{
    ...
    EXPECT_NEAR(0.857620132, T, 1e-6);
...
TEST_F(EquivalentSpecularLayer_21467, TestAngleHemispherical10)
{
    ...
    EXPECT_NEAR(0.0366254955, Abs1, 1e-6);
}
