...
TEST_F(MultiPaneBSDF_102_Perforated, Test102PerofratedCircular)
{
    ...
    EXPECT_NEAR(0.521841, rhoHem, 1e-6);
    ...
    EXPECT_NEAR(0.135517, abs1, 1e-6);
    ...
    EXPECT_NEAR(0.544654, rhoHem, 1e-6);
    ...
    EXPECT_NEAR(0.143874, abs1, 1e-6);
