...
private:
    ...
    std::shared_ptr<CSpectralSampleData> loadSampleData_NFRC_102()
    {
        ...
        aMeasurements_102->addRecord(0.310, 0.007, 0.0471, 0.0471);
        aMeasurements_102->addRecord(0.315, 0.035, 0.047, 0.047);
        aMeasurements_102->addRecord(0.320, 0.0975, 0.0472, 0.0472);
        aMeasurements_102->addRecord(0.325, 0.2099, 0.0487, 0.0487);
        aMeasurements_102->addRecord(0.330, 0.3497, 0.0525, 0.0525);
        aMeasurements_102->addRecord(0.335, 0.4865, 0.0581, 0.0581);
        aMeasurements_102->addRecord(0.340, 0.6057, 0.0644, 0.0644);
        aMeasurements_102->addRecord(0.345, 0.7035, 0.0706, 0.0706);
        aMeasurements_102->addRecord(0.350, 0.7687, 0.0751, 0.0751);
        aMeasurements_102->addRecord(0.355, 0.812, 0.0783, 0.0783);
        aMeasurements_102->addRecord(0.360, 0.8429, 0.0806, 0.0806);
        aMeasurements_102->addRecord(0.365, 0.862, 0.0819, 0.0819);
        aMeasurements_102->addRecord(0.370, 0.8678, 0.0821, 0.0821);
        aMeasurements_102->addRecord(0.375, 0.8672, 0.0819, 0.0819);
        aMeasurements_102->addRecord(0.380, 0.8554, 0.0806, 0.0806);
        aMeasurements_102->addRecord(0.385, 0.8696, 0.0816, 0.0816);
        aMeasurements_102->addRecord(0.390, 0.8804, 0.0823, 0.0823);
        aMeasurements_102->addRecord(0.395, 0.8884, 0.0828, 0.0828);
        aMeasurements_102->addRecord(0.400, 0.8924, 0.083, 0.083);
        aMeasurements_102->addRecord(0.410, 0.8944, 0.0828, 0.0828);
        aMeasurements_102->addRecord(0.420, 0.8921, 0.0823, 0.0823);
        aMeasurements_102->addRecord(0.430, 0.8914, 0.082, 0.082);
        aMeasurements_102->addRecord(0.440, 0.8896, 0.0815, 0.0815);
        aMeasurements_102->addRecord(0.450, 0.8933, 0.0816, 0.0816);
        aMeasurements_102->addRecord(0.460, 0.8972, 0.0817, 0.0817);
        aMeasurements_102->addRecord(0.470, 0.8991, 0.0816, 0.0816);
        aMeasurements_102->addRecord(0.480, 0.9013, 0.0816, 0.0816);
        aMeasurements_102->addRecord(0.490, 0.9026, 0.0815, 0.0815);
        aMeasurements_102->addRecord(0.500, 0.9026, 0.0813, 0.0813);
        aMeasurements_102->addRecord(0.510, 0.9031, 0.0811, 0.0811);
        aMeasurements_102->addRecord(0.520, 0.9025, 0.0809, 0.0809);
        aMeasurements_102->addRecord(0.530, 0.9028, 0.0808, 0.0808);
        aMeasurements_102->addRecord(0.540, 0.9033, 0.0807, 0.0807);
        aMeasurements_102->addRecord(0.550, 0.9013, 0.0804, 0.0804);
        aMeasurements_102->addRecord(0.560, 0.8999, 0.0802, 0.0802);
        aMeasurements_102->addRecord(0.570, 0.8986, 0.0799, 0.0799);
        aMeasurements_102->addRecord(0.580, 0.8975, 0.0797, 0.0797);
        aMeasurements_102->addRecord(0.590, 0.8939, 0.0793, 0.0793);
        aMeasurements_102->addRecord(0.600, 0.8919, 0.079, 0.079);
        aMeasurements_102->addRecord(0.610, 0.891, 0.0789, 0.0789);
        aMeasurements_102->addRecord(0.620, 0.8853, 0.0783, 0.0783);
        aMeasurements_102->addRecord(0.630, 0.8838, 0.0781, 0.0781);
        aMeasurements_102->addRecord(0.640, 0.8806, 0.0777, 0.0777);
        aMeasurements_102->addRecord(0.650, 0.8769, 0.0773, 0.0773);
        aMeasurements_102->addRecord(0.660, 0.8735, 0.077, 0.077);
        aMeasurements_102->addRecord(0.670, 0.8731, 0.0769, 0.0769);
        aMeasurements_102->addRecord(0.680, 0.8665, 0.0763, 0.0763);
        aMeasurements_102->addRecord(0.690, 0.8637, 0.076, 0.076);
        aMeasurements_102->addRecord(0.700, 0.8607, 0.0757, 0.0757);
        aMeasurements_102->addRecord(0.710, 0.8557, 0.0753, 0.0753);
        aMeasurements_102->addRecord(0.720, 0.8531, 0.075, 0.075);
        aMeasurements_102->addRecord(0.730, 0.8487, 0.0746, 0.0746);
        aMeasurements_102->addRecord(0.740, 0.8418, 0.074, 0.074);
        aMeasurements_102->addRecord(0.750, 0.8406, 0.0738, 0.0738);
        aMeasurements_102->addRecord(0.760, 0.8358, 0.0734, 0.0734);
        aMeasurements_102->addRecord(0.770, 0.8341, 0.0732, 0.0732);
        aMeasurements_102->addRecord(0.780, 0.8324, 0.073, 0.073);
        aMeasurements_102->addRecord(0.790, 0.8232, 0.0723, 0.0723);
        aMeasurements_102->addRecord(0.800, 0.8246, 0.0723, 0.0723);
        aMeasurements_102->addRecord(0.850, 0.8076, 0.0708, 0.0708);
        aMeasurements_102->addRecord(0.900, 0.8002, 0.07, 0.07);
        aMeasurements_102->addRecord(0.950, 0.7907, 0.0692, 0.0692);
        aMeasurements_102->addRecord(1.000, 0.7862, 0.0687, 0.0687);
        aMeasurements_102->addRecord(1.050, 0.7849, 0.0685, 0.0685);
        aMeasurements_102->addRecord(1.100, 0.7848, 0.0683, 0.0683);
        aMeasurements_102->addRecord(1.150, 0.7864, 0.0683, 0.0683);
        aMeasurements_102->addRecord(1.200, 0.7894, 0.0685, 0.0685);
        aMeasurements_102->addRecord(1.250, 0.7944, 0.0687, 0.0687);
        aMeasurements_102->addRecord(1.300, 0.8014, 0.0691, 0.0691);
        aMeasurements_102->addRecord(1.350, 0.8088, 0.0695, 0.0695);
        aMeasurements_102->addRecord(1.400, 0.8168, 0.07, 0.07);
        aMeasurements_102->addRecord(1.450, 0.8261, 0.0705, 0.0705);
        aMeasurements_102->addRecord(1.500, 0.8366, 0.0712, 0.0712);
        aMeasurements_102->addRecord(1.550, 0.8444, 0.0716, 0.0716);
        aMeasurements_102->addRecord(1.600, 0.8506, 0.0719, 0.0719);
        aMeasurements_102->addRecord(1.650, 0.853, 0.072, 0.072);
        aMeasurements_102->addRecord(1.700, 0.8527, 0.0719, 0.0719);
        aMeasurements_102->addRecord(1.750, 0.8532, 0.0718, 0.0718);
        aMeasurements_102->addRecord(1.800, 0.8504, 0.0714, 0.0714);
        aMeasurements_102->addRecord(1.850, 0.8488, 0.0712, 0.0712);
        aMeasurements_102->addRecord(1.900, 0.8523, 0.0713, 0.0713);
        aMeasurements_102->addRecord(1.950, 0.8497, 0.071, 0.071);
        aMeasurements_102->addRecord(2.000, 0.848, 0.0708, 0.0708);
        aMeasurements_102->addRecord(2.050, 0.8488, 0.0707, 0.0707);
        aMeasurements_102->addRecord(2.100, 0.8505, 0.0707, 0.0707);
        aMeasurements_102->addRecord(2.150, 0.8408, 0.0699, 0.0699);
        aMeasurements_102->addRecord(2.200, 0.8304, 0.0691, 0.0691);
        aMeasurements_102->addRecord(2.250, 0.8277, 0.0688, 0.0688);
        aMeasurements_102->addRecord(2.300, 0.8303, 0.0688, 0.0688);
        aMeasurements_102->addRecord(2.350, 0.834, 0.069, 0.069);
        aMeasurements_102->addRecord(2.400, 0.8236, 0.0681, 0.0681);
        aMeasurements_102->addRecord(2.450, 0.8225, 0.0679, 0.0679);
        aMeasurements_102->addRecord(2.500, 0.8184, 0.0675, 0.0675);
    ...
    std::shared_ptr<CSingleAngularMeasurement> getSample1()
    {
        ...
        aMeasurements0->addRecord(0.295, 0, 0.0475, 0.0475);
    ...
    std::shared_ptr<CSingleAngularMeasurement> getSample2()
    {
        ...
        aMeasurements1->addRecord(0.295, 0, 0.0475, 0.0475);
...
TEST_F(EquivalentSpecularAngularDualLayer_102_103, TestAngle10)
{
    ...
    double T = aLayer.getProperty(Side::Front, Property::T, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.718729693224059, T, 1e-6);

    double Rf = aLayer.getProperty(Side::Front, Property::R, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.128242049471907, Rf, 1e-6);

    double Rb = aLayer.getProperty(Side::Back, Property::R, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.128241345602035, Rb, 1e-6);

    double Abs1 = aLayer.Abs(1, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.0867950051351273, Abs1, 1e-6);

    double Abs2 = aLayer.Abs(2, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.0662332521689053, Abs2, 1e-6);
}
...
TEST_F(EquivalentSpecularAngularDualLayer_102_103, TestAngle25)
{
    ...
    double T = aLayer.getProperty(Side::Front, Property::T, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.67819673620277, T, 1e-6);

    double Rf = aLayer.getProperty(Side::Front, Property::R, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.157389949882287, Rf, 1e-6);

    double Rb = aLayer.getProperty(Side::Back, Property::R, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.162798780313507, Rb, 1e-6);

    double Abs1 = aLayer.Abs(1, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.0921612762642473, Abs1, 1e-6);

    double Abs2 = aLayer.Abs(2, angle, minLambda, maxLambda);
    EXPECT_NEAR(0.072252037650695, Abs2, 1e-6);
}
