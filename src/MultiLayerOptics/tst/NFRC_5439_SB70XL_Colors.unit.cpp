...
private:
	...
	std::shared_ptr< MultiLayerOptics::ColorProperties > m_Color;
...
protected:
	void SetUp() override {
		...
		m_Color = std::make_shared< MultiLayerOptics::ColorProperties >( LayerX, LayerY, LayerZ,
...
public:
	...
	std::shared_ptr< MultiLayerOptics::ColorProperties > getLayer() const {
		return m_Color;
	}
...
TEST_F( TestNFRC_5439_SB70XL_Colors, Test1 ) {
	...
	std::shared_ptr< MultiLayerOptics::ColorProperties > aLayer = getLayer();
