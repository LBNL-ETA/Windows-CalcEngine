...
public:
  shared_ptr< CEquivalentLayerSingleComponent > getDoubleBack() { return m_DoubleBack; };
  shared_ptr< CEquivalentLayerSingleComponent > getDoubleFront() { return m_DoubleFront; };
