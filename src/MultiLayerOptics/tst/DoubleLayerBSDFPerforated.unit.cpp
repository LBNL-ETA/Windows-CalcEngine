...
protected:
    virtual void SetUp()
    {
        ...
        double Rfmat = 0.75;
        double Rbmat = 0.66;
        std::shared_ptr<CMaterial> perfMaterial = std::make_shared<CMaterialSingleBand>(Tmat, Tmat, Rfmat, Rbmat, minLambda, maxLambda);
...
TEST_F(TestDoubleLayerBSDFPerforated, TestDoubleLayerBSDF)
{
    ...
    SquareMatrix correctTf{{4.02734229, 0.04807644, 0.04923533, 0.05014887, 0.04956643, 0.04042293, 0.01069836},
    ...
    SquareMatrix correctRf{{1.53453038, 0.14025367, 0.14363451, 0.14629956, 0.14460041, 0.11792603, 0.0312104},
    ...
    SquareMatrix correctTb{{4.02734229, 0.04789303, 0.0491344, 0.05109201, 0.05490417, 0.05872637, 0.05872637},
    ...
    SquareMatrix correctRb{{0.25123617, 0.16414142, 0.16913772, 0.17605257, 0.1881739, 0.21323834, 0.21323834},
