...
TEST_F( MultiPaneScattered_102_VenetianUniform, TestVenetianUniformDirectBeam ) {
	SCOPED_TRACE( "Begin Test: Venetian (uniform) layer - Scattering model front side (normal incidence)." );
...
TEST_F( MultiPaneScattered_102_VenetianUniform, TestVenetianUniformAngledBeam25 ) {
	SCOPED_TRACE( "Begin Test: Venetian (uniform) layer - Scattering model back side (normal incidence)." );
...
TEST_F( MultiPaneScattered_102_VenetianUniform, TestVenetianUniformAngleBeam50 ) {
	SCOPED_TRACE( "Begin Test: Venetian (uniform) layer - Scattering model front side (Theta = 50 deg)." );
