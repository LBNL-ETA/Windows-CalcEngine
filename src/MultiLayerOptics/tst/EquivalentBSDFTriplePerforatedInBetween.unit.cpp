...
protected:
    virtual void SetUp()
    {
        ...
        double Rfmat = 0.75;
        double Rbmat = 0.66;
        std::shared_ptr<CMaterialSingleBand> perfMaterial = std::make_shared<CMaterialSingleBand>(Tmat, Tmat, Rfmat, Rbmat, minLambda, maxLambda);
        ...
        std::shared_ptr<CCircularCellDescription> perfCellDescription = std::make_shared<CCircularCellDescription>(x, y, thickness, radius);
...
TEST_F(TestEquivalentBSDFTriplePerforatedInBetween, TestTripleLayerBSDF)
{
    ...
    SquareMatrix correctTf{{3.36513193e+00, 4.59380024e-02, 4.68677211e-02, 4.76966681e-02, 4.73625159e-02, 3.67802927e-02, 9.73430146e-03},
                           {4.46793459e-02, 4.46431913e-01, 4.65707959e-02, 4.73943209e-02, 4.70632076e-02, 3.65401206e-02, 9.67073732e-03},
                           {4.41904097e-02, 4.51474410e-02, 2.51387826e-01, 4.68740921e-02, 4.65474460e-02, 3.61326817e-02, 9.56290421e-03},
                           {4.31949401e-02, 4.41302523e-02, 4.50218651e-02, 1.90007197e-01, 4.54987154e-02, 3.53170393e-02, 9.34703564e-03},
                           {4.01801835e-02, 4.10510163e-02, 4.18811610e-02, 4.26217572e-02, 1.40277551e-01, 3.28605399e-02, 8.69689657e-03},
                           {2.71591829e-02, 2.77418896e-02, 2.82973794e-02, 2.87965021e-02, 2.86021785e-02, 2.21492350e-02, 5.86203413e-03},
                           {7.18797091e-03, 7.34219052e-03, 7.48920688e-03, 7.62130510e-03, 7.56987525e-03, 5.86203413e-03, 1.55145060e-03}};
    ...
    SquareMatrix correctTb{{3.36513193e+00, 4.59095348e-02, 4.68120912e-02, 4.76335341e-02, 4.73314850e-02, 3.64804663e-02, 9.65494917e-03},
                           {4.47070507e-02, 4.46431913e-01, 4.65443606e-02, 4.73609334e-02, 4.70615300e-02, 3.62646620e-02, 9.59783423e-03},
                           {4.42429240e-02, 4.51730829e-02, 2.51387826e-01, 4.68676734e-02, 4.65722169e-02, 3.58806153e-02, 9.49619213e-03},
                           {4.32521911e-02, 4.41613623e-02, 4.50280310e-02, 1.90007197e-01, 4.55291599e-02, 3.50754692e-02, 9.28310153e-03},
                           {4.02065259e-02, 4.10524796e-02, 4.18588852e-02, 4.25932568e-02, 1.40277551e-01, 3.26140384e-02, 8.63165729e-03},
                           {2.73823994e-02, 2.79526110e-02, 2.84961724e-02, 2.89948279e-02, 2.88183577e-02, 2.21492350e-02, 5.86203413e-03},
                           {7.24704756e-03, 7.39796023e-03, 7.54181961e-03, 7.67379417e-03, 7.62708943e-03, 5.86203413e-03, 1.55145060e-03}};
    ...
    SquareMatrix correctRf{{1.60088517, 0.14313834, 0.14652042, 0.14922345, 0.14757476, 0.11967244, 0.031672600},
    ...
    SquareMatrix correctRb{{1.58527489, 0.12471521, 0.12765346, 0.13000635, 0.12858011, 0.10418067, 0.027572540},
